...
public:
  ...
  //calculate forces
  glm::vec3 force_between_2_point(int i, int j,int k, int l,int indicator);
  glm::vec3 compute_structural_force(int i, int j);
  glm::vec3 compute_shear_force(int i, int j);
  glm::vec3 compute_bend_force(int i, int j);
  //calculate provot correction
  void compute_provot_structural();
  void compute_provot_shear();
  void correct_position_2_particle(ClothParticle& pij,ClothParticle& pkl,int indicator);
private:
